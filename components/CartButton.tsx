...
/**
 * Falls du beim Hinzufügen zum Warenkorb irgendwo in deinem Code
 * nach dem localStorage-Update zusätzlich
 *   window.dispatchEvent(new CustomEvent("cart:changed"))
 * rufst, aktualisiert sich das Badge sofort – sonst über den 'storage'-Listener.
 */
