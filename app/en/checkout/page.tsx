  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="mb-4 flex items-center gap-2">
        <div className="text-sm opacity-80">Shipping region:</div>
        <select
          value={region}
          onChange={(e) => {
        ...
        <div className="ml-auto w-full sm:w-auto text-right">
          ...
          {shippingOptions.length > 0 && (
            <div className="mt-3 text-left">
              <div className="opacity-70 text-sm mb-1">Shipping option:</div>
              <select
          ...
          <div className="mt-3 opacity-70 text-sm">Total</div>
          ...
          >
            {creating ? "Continue to Stripe …" : "Pay by card / Apple Pay"}
          </button>
