...
export default function AdminEditDvdPage({ params }: { params: { id: string } }) {
  const { id } = params;
    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <a href="/admin/dvds" className="px-3 py-2 rounded bg-white/10 hover:bg-white/20">Zur Liste</a>
      ...
      <p className="text-white/70 mt-2">
        Bilder unten ändern; einzelne Bilder in der Leiste mit ✕ entfernen (in <code>ImageDrop</code>).
      </p>
      ...
      <div className="mt-8">
        <form ref={formRef} onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <L label="Format">
              <input name="format" defaultValue={p.format || (p.categoryCode === "br" ? "Blu-ray" : "DVD")} className="input" />
            </L>
