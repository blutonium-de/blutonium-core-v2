// app/admin/page.tsx  (Backend-Startseite)
"use client";
...
export default function AdminHome() {
  ...
  const ordersHref = key ? `/admin/orders?key=${encodeURIComponent(key)}` : "/admin/orders";
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* NEU: DVD/Blu-ray anlegen */}
        <Link
          href="/admin/dvds/new"
          className="group rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors p-6 block"
        >
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold">Neu DVD • Blu-ray anlegen</h2>
            <span className="text-2xl">➕</span>
          </div>
          <p className="mt-2 opacity-70">
            Neuen Film mit Fotos/Barcode anlegen. Auto-Felder &amp; Import-Helfer inklusive.
          </p>
          <div className="mt-4 inline-flex items-center gap-2 text-cyan-400 group-hover:underline">
            Öffnen <span>→</span>
          </div>
