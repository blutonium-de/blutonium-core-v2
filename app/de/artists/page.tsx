  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-14">
      ...
      <p className="opacity-70 mt-1">
        Blutonium Records Artists. Booking-Anfragen bitte an:{" "}
        <a
          href="mailto:mac.office@blutonium.de?subject=Booking%20Request%20%E2%80%93%20Blutonium%20Artist"
          className="underline underline-offset-2 hover:text-cyan-300"
        >
          mac.office@blutonium.de
        </a>
      </p>
      ...
      {artists.length === 0 ? (
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {artists.map((a) => {
            const subject = `Booking Request – ${a.name}`;
            const body = [
              `Hallo Blutonium,`,
              ``,
              `ich möchte eine Booking-Anfrage für ${a.name} stellen.`,
              ``,
              `Datum:`,
              `Ort/Club:`,
              `Budget:`,
            ...
            const mailto = `mailto:mac.office@blutonium.de?subject=${encodeURIComponent(
              subject
            ...
            return (
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  {/* Booking-Button: öffnet Mail mit Artist im Betreff */}
                  <a
                    href={mailto}
                    className="mt-4 w-full px-3 py-2 rounded bg-white/10 hover:bg-white/20 text-sm text-center block"
                    aria-label={`Booking-Anfrage für ${a.name} per E-Mail`}
                  >
                    Book now
                  </a>
                </div>
