// app/de/shop/techno-12-maxi-90s/page.tsx
...
export const metadata: Metadata = {
  title: `Techno 12" Maxi Singles (90s) – gebraucht | Blutonium Records`,
  description: `Techno 12" Maxis aus den 90ern – Klassiker & Raritäten. Gebraucht, geprüft, weltweiter Versand.`,
  alternates: { canonical: "/de/shop/techno-12-maxi-90s" },
  openGraph: {
    title: `Techno 12" Maxi Singles (90s) – gebraucht | Blutonium Records`,
    description: `Techno 12" Maxis (90s) – geprüfte Qualität, weltweiter Versand.`,
    url: "/de/shop/techno-12-maxi-90s",
    type: "website",
  },
};

export default async function Techno90sLanding({ searchParams }: { searchParams?: { page?: string } }) {
  ...
  const where: any = {
    ...
    stock: { gt: 0 },
    genre: "Techno",
    OR: [{ year: null }, { AND: [{ year: { gte: 1990 } }, { year: { lte: 1999 } }] }],
  };
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6">
      <section className="mb-6 text-center max-w-3xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-extrabold mb-2">Techno 12&quot; Maxi Singles – 90s</h1>
        <p className="text-sm md:text-base text-white/80 leading-relaxed">
          <strong>Techno</strong> 12&quot; Maxis aus den 90ern – Klassiker &amp; Raritäten, geprüft &amp; versandfertig. Internationaler Versand.
        </p>
        <div className="mt-4">
