// app/de/shop/italo-disco-12-maxi-vinyl/page.tsx
...
export const metadata: Metadata = {
  title: `Italo Disco 12" Maxi Singles (1983–1992) – Raritäten | Blutonium Records`,
  description: `Originale Italo Disco 12" Maxi Singles (1983–1992). Rare Pressungen, geprüft & gepflegt. Weltweiter Versand.`,
  alternates: { canonical: "/de/shop/italo-disco-12-maxi-vinyl" },
  openGraph: {
    title: `Italo Disco 12" Maxi Singles (1983–1992) – Raritäten | Blutonium Records`,
    description: `Seltene Italo Disco 12" Maxis (1983–1992) – geprüfte Qualität, weltweiter Versand.`,
    url: "/de/shop/italo-disco-12-maxi-vinyl",
    type: "website",
  },
};

export default async function ItaloDiscoLanding({ searchParams }: { searchParams?: { page?: string } }) {
  ...
  const where: any = {
    ...
    stock: { gt: 0 },
    genre: "Italo Disco",
    OR: [{ year: null }, { AND: [{ year: { gte: 1983 } }, { year: { lte: 1992 } }] }],
  };
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6">
      <section className="mb-6 text-center max-w-3xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-extrabold mb-2">Italo Disco 12&quot; Maxi Singles (1983–1992)</h1>
        <p className="text-sm md:text-base text-white/80 leading-relaxed">
          Entdecke originale <strong>Italo Disco</strong> 12&quot; Maxis aus der Blütezeit 1983–1992 – 
          geprüfte Qualität, seltene Pressungen, <strong>internationaler Versand</strong>.
        </p>
        <div className="mt-4">
